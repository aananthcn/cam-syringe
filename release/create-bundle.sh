...
# release/create-bundle.sh's own header comment for why), points
...
if [ -n "$MISSING" ]; then
    ...
    echo "(if your distro's package names/versions differ, see release/create-bundle.sh's" >&2
...
# Generated by release/create-bundle.sh.
set -e
